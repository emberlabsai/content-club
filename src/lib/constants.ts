...
export const MODE_LABELS: Record<GenerationMode, string> = {
  ...
  [GenerationMode.FRAMES_TO_VIDEO]: 'Image to Video',
...
export const MODE_DESCRIPTIONS: Record<GenerationMode, string> = {
  [GenerationMode.TEXT_TO_VIDEO]:
    'Generate a video purely from a text description. Ideal for bringing creative concepts to life.',
  [GenerationMode.FRAMES_TO_VIDEO]:
    'Animate from an image, or create a transition between a start and end frame.',
  [GenerationMode.REFERENCES_TO_VIDEO]:
    'Use up to 3 reference images (characters, environments, or styles) to guide generation.',
